...
- 컴퓨터 숫자를 랜덤한 숫자의 배열로 뽑기
- 사용자가 잘못된 값을 입력했을 때 alert로 알려주기
- 사용자의 입력값을 문자열에서 숫자 배열로 바꿔주기
- 컴퓨터 숫자와 사용자 입력값 비교하기
- 3 스트라이크일 경우 게임 종료하고, 재시작 버튼 띄우기
- 재시작 버튼을 눌렀을 때 게임을 재시작하기
- 결과 간의 구별을 위해 이모지 함께 출력하기
