...
- 게임 초기화 기능 : 정답이 될 새 컴퓨터 숫자를 할당하고 eventListner를 등록하는 기능
- 컴퓨터 숫자 생성 기능 : 중복과 0을 포함하지 않는 세자리 숫자 생성 기능
- 입력 받기 기능 : 유저 입력을 받아 검증 성공 시 게임 플레이, 실패 시 재입력을 요청하는 기능
- 입력 검증 기능 : 중복 숫자 여부, 0 포함 여부, 자릿수, 데이터 타입을 검증하는 기능
- 두 숫자 비교 기능 : 유저 입력과 컴퓨터 숫자를 비교해 ball, strike를 count하고 결과 문자열을 반환하는 기능
- 인덱스 반환 기능 : 특정 자리 숫자가 컴퓨터 숫자에 존재한다면 해당 index를 반환하여 strike 혹은 ball 여부를 판단하는 기능
- 결과 출력 기능 : 게임 결과 문자열을 화면에 출력하는 기능
- 결과 초기화 기능 : 게임 재시작 시 결과 문자열을 지우는 기능
