...
[o] 중복되지 않는 세개의 랜덤 숫자로 computer number 생성 <br>
[o] 사용자에게 입력받은 수 유효성 검증하고 유효하지 않으면 alert 창 띄우기 <br>
[o] 스트라이크, 볼, 낫싱, 정답 여부 출력해주는 play 함수 구현 <br>
[o] 스트라이크 카운트 함수 구현 <br>
[o] 볼 카운트 함수 구현 <br>
[o] 정답이면 게임 종료하고 재시작 여부 묻기 <br>
[o] 재시작 버튼 클릭 시 게임 재시작 <br>
