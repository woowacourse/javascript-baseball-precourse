...
- [x] 올바른 입력인지 확인하는 기능
  - 예외 처리
    ...
    - [x] 숫자가 세 자리가 아닌 경우
    - [x] 숫자가 중복되는 경우
- [x] 입력이 올바르지 않은 경우 `alert` 를 호출하는 기능

- [x] 컴퓨터 숫자와 사용자 숫자를 비교하는 기능
  - 스트라이크와 볼 개수
- [x] 비교한 결과를 출력하는 기능
  - [x] 정답을 맞춘 경우
    - 축하 문구 및 게임 재시작 버튼 생성
  - [x] 정답을 맞추지 못한 경우
    - 프로그래밍 요구 사항 준수(볼이 앞에 나오도록)
- [x] 게임 재시작 버튼을 누르면 게임이 다시 시작되는 기능
...
- [x] [자바스크립트 코드 컨벤션](https://ui.toast.com/fe-guide/ko_CODING-CONVENTION)을 지키면서 프로그래밍 한다.
