...
export default class BaseballGame {
  ...
  play(computerInputNumbers, userInputNumbers) {
    const [cntBall, cntStrike] = BaseballGame.determineResult(
      computerInputNumbers,
      userInputNumbers,
    );

    const result = BaseballGame.convertCntToStringResult(cntBall, cntStrike);

    return result;
  }

  static determineResult(computerInputNumbers, userInputNumbers) {
  ...
  static convertCntToStringResult(cntBall, cntStrike) {
    let result = '';
...
baseBallGame.enrollSubmitOnclickHandler();
